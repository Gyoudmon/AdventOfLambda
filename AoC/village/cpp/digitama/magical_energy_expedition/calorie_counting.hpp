...
namespace WarGrey::AoC {
    ...
    /******************************************* 声明游戏世界 ******************************************/
    class CalorieCountingPlane : public GYDM::Plane {
    public:
    ...
    private: // 本游戏世界中的物体
        ...
        GYDM::Dimensionlet* top1_total;
        GYDM::Dimensionlet* topn_total;
        GYDM::Dimensionlet* sorted_total;
        GYDM::Labellet* info_board;
        GYDM::SpriteGridSheet* snack;
        std::vector<WarGrey::AoC::Elfmon*> elves;
        std::vector<GYDM::Labellet*> dims;
