...
@aoc-desc[#:keywords ["枚举类型"]
          #:edition [三 "2024-06-11"]]
...
@tamer-repl[#:requires ["../aoc.rkt"]
            (with-aoc-data-from "mee/02_rps.aoc" #:do simulate-with-guessed-strategy)]
...
@tamer-repl[(with-aoc-data-from "mee/02_rps.aoc" #:do simulate-with-designed-strategy)]
